...
namespace taylortrack{
    namespace utils{
        void fft_strategy::circshift(RArray &out,RArray &in, long xdim, long ydim,unsigned long xshift, unsigned long yshift) {
        ...
        CArray fft_strategy::converttocomp(RArray &x) {
