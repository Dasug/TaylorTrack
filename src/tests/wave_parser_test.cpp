...
TEST(WaveParserTest, ValidExample) {
  taylortrack::utils::WaveParser parser("../Testdata/Test.wav");
...
TEST(WaveParserTest, NoRIFFHeader) {
  taylortrack::utils::WaveParser parser("../Testdata/Testnoriff.wav");
  ASSERT_FALSE(parser.is_valid());
}

TEST(WaveParserTest, NoDataHeader) {
  taylortrack::utils::WaveParser parser("../Testdata/Testnodata.wav");
  ASSERT_FALSE(parser.is_valid());
}

TEST(WaveParserTest, NofmtHeader) {
  taylortrack::utils::WaveParser parser("../Testdata/Testnofmt.wav");
  ASSERT_FALSE(parser.is_valid());
}

TEST(WaveParserTest, NoWaveFormat) {
  taylortrack::utils::WaveParser parser("../Testdata/Testwave.wav");
  ASSERT_FALSE(parser.is_valid());
}

TEST(WaveParserTest, NonExistingFile) {
  taylortrack::utils::WaveParser parser("../Testdata/CertainlyNotExistingFile.wav");
  ASSERT_FALSE(parser.is_valid());
}
